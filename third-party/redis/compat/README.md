...
hash-field-expiry, Cluster and Monitoring rows, the `redis-compat-phase3`
branch add the following on top of PR 72, all implemented in the adapter with
no changes below `makoCon`:
